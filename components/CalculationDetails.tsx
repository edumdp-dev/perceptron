...
const CalculationDetails: React.FC<CalculationDetailsProps> = ({ calculation }) => {
    const { x1, x2, y_actual, z, y_predicted, error, old_w1, old_w2, old_b, new_w1, new_w2, new_b, learningRate, sigmoidOutput, activationFunction } = calculation;

    return (
        <div className="bg-white dark:bg-gray-900 border border-red-500/30 rounded-xl p-4 shadow-lg animate-fade-in text-left">
            <h3 className="text-base font-bold text-red-500 dark:text-red-400 mb-3 flex items-center">
            ...
            <div className="space-y-1 text-xs text-slate-700 dark:text-gray-300">
                ...
                <div>
                    <h4 className="font-semibold text-slate-600 dark:text-gray-300 text-xs">1. Soma Ponderada (z)</h4>
